...
PortusSophia™ contains several complementary resources, each written for a different purpose.

Rather than reading everything sequentially, readers are encouraged to begin with the pathway that best matches their interests.
...
Each page has been written to stand on its own while contributing to a coherent understanding of the PortusSophia™ research program.